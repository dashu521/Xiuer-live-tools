...
const Sidebar = memo(function Sidebar() {
  ...
  return (
    <aside
      data-tour="sidebar"
      className="w-56 min-w-[14rem] relative z-[1] flex flex-col"
      style={{
        ...
        <nav className="space-y-0.5">
          {filteredSystemTabs.map(tab => (
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  'group flex items-center gap-3 px-3 py-2 text-sm rounded-lg transition-colors duration-150 relative',
                  isActive
